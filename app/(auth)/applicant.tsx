...
export default function CreateAccount() {
  ...
  const [showSexModal, setShowSexModal] = useState(false); // ✅ added state
...
const handleSignUp = async () => {
  ...
  const openProvinceModal = () => setShowProvinceModal(true);
  ...
  // Sex modal handlers ✅
  const openSexModal = () => setShowSexModal(true);
  ...
  return (
    ...
    >
      ...
      {step === 1 && (
        <>
          <Text style={[styles.label, { top: 265 }]}>First Name</Text>
          <TextInput
          ...
          <Text style={[styles.label, { top: 345 }]}>Last Name</Text>
          <TextInput
          ...
          <Text style={[styles.label, { top: 425 }]}>Age</Text>
          <TextInput
          ...
          <Text style={[styles.label, { top: 505 }]}>Sex</Text>
          <TouchableOpacity
            style={[styles.input, { top: 530, justifyContent: "center" }]}
          ...
          <Text style={[styles.label, { top: 590 }]}>Address</Text>
          <TouchableOpacity
            style={[styles.input, { top: 615, justifyContent: "center" }]}
            onPress={openProvinceModal}
          >
            <Text
              style={{
                color: formData.address ? "#000" : "#cccccc",
                fontSize: 16,
              }}
            >
              {formData.address || "Select Province and City"}
            </Text>
          </TouchableOpacity>
